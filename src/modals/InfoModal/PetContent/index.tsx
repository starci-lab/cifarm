...
import { PetType, PlacedItemSchema } from "@/types"
                ...
                <div className="bg-content-2 rounded-lg overflow-hidden">
                    <div className="p-3">
                        ...
                        <div className="text-4xl text-primary leading-none">
                            {`${(
                                (staticData?.petInfo[pet.type].chance ?? 0) * 100
                            ).toFixed(2)}%`}
                        </div>
                    </div>
                    <Separator />
                        ...
                        <div>
                            <div className="flex justify-between items-center p-3">
                                ...
                                <div className="leading-none">
                                    {staticData?.petInfo[pet.type].plusQuantity}
                                </div>
                            </div>
                            <Separator />
                            <div className="flex justify-between items-center p-3">
                    ...
                    {pet.type === PetType.Dog && (
                        <div className="p-3">
                            <div className="flex justify-between items-center">
                                ...
                                />
                                <div className="leading-none">
                                    {staticData?.petInfo[pet.type].energyReduce}
                                </div>
                            </div>  
                        </div>
                    )}

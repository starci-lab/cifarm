...
export enum BaseAssetKey {
    ...
    UIModalShopButtonPrice = "ui-modal-shop-button-price",
    UIModalShopIconTabOn = "ui-modal-shop-icon-tab-on",
    UIModalShopIconTabOff = "ui-modal-shop-icon-tab-off",
    UIModalShopItemCard = "ui-modal-shop-item-card",
    UIModalShopTitleShop = "ui-modal-shop-title-shop",
    UIModalShopTopbar = "ui-modal-shop-top-bar",
    UIModalShopWall = "ui-modal-shop-wall",
    UIModalShopTopDecorator = "ui-modal-shop-top-decorator",
    UIModalShopBottomDecorator = "ui-modal-shop-bottom-decorator",
    UIModalShopCardTitle = "ui-modal-shop-card-title",
    UIModalShopX = "ui-modal-shop-x",
    UIModalShopIconSeed = "ui-modal-shop-icon-seed",
    UIModalShopIconAnimal = "ui-modal-shop-icon-animal",
    UIModalShopIconBuilding = "ui-modal-shop-icon-building",
    UIModalShopIconTree = "ui-modal-shop-icon-tree",
    UIModalShopIconDecoration = "ui-modal-shop-icon-decoration",
    UIModalShopIconOther = "ui-modal-shop-icon-other",
...
export const baseAssetMap: Record<BaseAssetKey, string> = {
    ...
    [BaseAssetKey.UIModalShopBottomBar]: "ui/modals/shop/bottom-bar.png",
    [BaseAssetKey.UIModalShopButtonPrice]: "ui/modals/shop/button-price.png",
    [BaseAssetKey.UIModalShopItemCard]: "ui/modals/shop/item-card.png",
    [BaseAssetKey.UIModalShopTitleShop]: "ui/modals/shop/title-shop.png",
    [BaseAssetKey.UIModalShopTopbar]: "ui/modals/shop/top-bar.png",
    [BaseAssetKey.UIModalShopWall]: "ui/modals/shop/wall.png",
    [BaseAssetKey.UIModalShopTopDecorator]: "ui/modals/shop/top-decorator.png",
    [BaseAssetKey.UIModalShopBottomDecorator]: "ui/modals/shop/bottom-decorator.png",
    [BaseAssetKey.UIModalShopIconTabOn]: "ui/modals/shop/icon-tab-on.png",
    [BaseAssetKey.UIModalShopIconTabOff]: "ui/modals/shop/icon-tab-off.png",
    [BaseAssetKey.UIModalShopCardTitle]: "ui/modals/shop/card-title.png",
    [BaseAssetKey.UIModalShopX]: "ui/modals/shop/x.png",
    [BaseAssetKey.UIModalShopIconSeed]: "crops/carrot/seed.png",
    [BaseAssetKey.UIModalShopIconAnimal]: "animals/chicken/baby.png",
    [BaseAssetKey.UIModalShopIconBuilding]: "building/coop.png",
    [BaseAssetKey.UIModalShopIconTree]: "ui/modals/shop/icon-tree.png",
    [BaseAssetKey.UIModalShopIconDecoration]: "ui/modals/shop/icon-decoration.png",
    [BaseAssetKey.UIModalShopIconOther]: "ui/modals/shop/icon-other.png",

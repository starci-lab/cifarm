    ...
    return (
        ...
        >
            <NavbarContent justify="start">
                <Link className="flex-1" color="foreground">
                    <div className="grid place-items-center">
                        <CiBitcoin className="w-6 h-6" />
                        <div className="text-[10px] h-4 flex items-center">Token/NFT</div>
                    </div>
                </Link>
                <Link className="flex-1 flex justify-end" color="foreground">
                    <div className="grid place-items-center">
            ...
            <NavbarContent justify="center">
                <Button size="lg" color="primary" onPress={() => {}}>
          Play
                </Button>
            </NavbarContent>

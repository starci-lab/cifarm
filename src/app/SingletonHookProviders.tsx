import {
    ...
    useGraphQLMutationThiefPlantSwrMutation,
    ...
    useGraphQLMutationThiefAnimalSwrMutation,
    useGraphQLMutationHelpUseAnimalMedicineSwrMutation,
    ...
    useGraphQLMutationUseAnimalMedicineSwrMutation,
    ...
    useGraphQLMutationHelpUseWateringCanSwrMutation,
    useGraphQLMutationUseAnimalFeedSwrMutation,
    useGraphQLMutationBuyCropSeedsSwrMutation,
    useGraphQLMutationBuyFlowerSeedsSwrMutation,
} from "@/hooks"
import {
...
export const SingletonHookProvider = ({ children }: PropsWithChildren) => (
    <BaseSingletonHookProvider
        hooks={{
            ...
            GRAPHQL_MUTATION_BUY_CROP_SEEDS_SWR_MUTATION: useGraphQLMutationBuyCropSeedsSwrMutation(),
            GRAPHQL_MUTATION_BUY_FLOWER_SEEDS_SWR_MUTATION: useGraphQLMutationBuyFlowerSeedsSwrMutation(),
            ...
            GRAPHQL_MUTATION_USE_WATERING_CAN_SWR_MUTATION: useGraphQLMutationUseWateringCanSwrMutation(),
            ...
            GRAPHQL_MUTATION_HARVEST_PLANT_SWR_MUTATION: useGraphQLMutationHarvestPlantSwrMutation(),
            ...
            GRAPHQL_MUTATION_HELP_USE_WATERING_CAN_SWR_MUTATION: useGraphQLMutationHelpUseWateringCanSwrMutation(),
            GRAPHQL_MUTATION_THIEF_PLANT_SWR_MUTATION: useGraphQLMutationThiefPlantSwrMutation(),
            ...
            GRAPHQL_MUTATION_THIEF_ANIMAL_SWR_MUTATION: useGraphQLMutationThiefAnimalSwrMutation(),
            GRAPHQL_MUTATION_HELP_USE_ANIMAL_MEDICINE_SWR_MUTATION: useGraphQLMutationHelpUseAnimalMedicineSwrMutation(),
            ...
            GRAPHQL_MUTATION_USE_ANIMAL_FEED_SWR_MUTATION: useGraphQLMutationUseAnimalFeedSwrMutation(),
            GRAPHQL_MUTATION_USE_ANIMAL_MEDICINE_SWR_MUTATION: useGraphQLMutationUseAnimalMedicineSwrMutation(),

...
export interface UseSignUmiSerializedTxSwrMutationArgs {
    serializedTx: string
}

export const useSignUmiSerializedTxSwrMutation = (): UseSWRMutation<
    SignUmiSerializedTxResponse,
    UseSignUmiSerializedTxSwrMutationArgs
> => {
    //get accounts
    ...
    const swrMutation = useSWRMutation(
        ...
        async (
            _: string,
            extraArgs: { arg: UseSignUmiSerializedTxSwrMutationArgs }
        ) => {

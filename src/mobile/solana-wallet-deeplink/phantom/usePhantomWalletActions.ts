...
export const usePhantomWalletActions = () => {
    ...
    const dappKeyPair = useAppSelector(state => state.walletReducer.solanaWallet.phantomDappKeyPair)
    const phantomSession = useAppSelector(state => state.walletReducer.solanaWallet.phantomSession)
    const phantomSharedSecret = useAppSelector(state => state.walletReducer.solanaWallet.phantomSharedSecret)
    const phantomProvider = useAppSelector(state => state.walletReducer.solanaWallet.phantomProvider)
